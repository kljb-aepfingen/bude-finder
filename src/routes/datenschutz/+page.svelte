...
<div class="flex flex-col h-dfull">
	<main class="flex flex-col p-4 flex-1 overflow-auto scroll-p-4">
		...
		<div class="ml-3">
			<p>
				...
				besonders hohen Stellenwert für die Geschäftsleitung der Bude Finder App. Eine Nutzung der
				Internetseiten der Bude Finder App ist grundsätzlich ohne jede Angabe personenbezogener
				Daten möglich. Sofern eine betroffene Person besondere Services unseres Unternehmens über
			...
			<p>
				...
				der Datenschutz-Grundverordnung und in Übereinstimmung mit den für die Bude Finder geltenden
			...
			<div class="p-1"></div>
			<p>
				Die Bude Finder App hat als für die Verarbeitung Verantwortlicher zahlreiche technische und
		...
		<ol class="counter-dec">
			<li>
				<h2>Begriffsbestimmungen</h2>
				<p>
					Die Datenschutzerklärung der Bude Finder App beruht auf den Begrifflichkeiten, die durch
				...
				<ol class="counter-alph">
					<li>
						...
						Person angesehen, die direkt oder indirekt, insbesondere mittels Zuordnung zu einer Kennung
						wie einem Namen, zu einer Kennnummer, zu Standortdaten, zu einer Online-Kennung oder zu einem
					...
					<li>
						<h3 class="counter-item">Petroffene Person</h3>
						ist jede identifizierte oder identifizierbare natürliche Person, deren personenbezogene Daten
						von dem für die Verarbeitung Verantwortlichen verarbeitet werden.
					</li>
					<li>
						<h3>Verarbeitung</h3>
						ist jeder mit oder ohne Hilfe automatisierter Verfahren ausgeführte Vorgang oder jede solche
						Vorgangsreihe im Zusammenhang mit personenbezogenen Daten wie das Erheben, das Erfassen,
						die Organisation, das Ordnen, die Speicherung, die Anpassung oder Veränderung, das Auslesen,
						das Abfragen, die Verwendung, die Offenlegung durch Übermittlung, Verbreitung oder eine andere
					...
					<li>
						...
						ist die Markierung gespeicherter personenbezogener Daten mit dem Ziel, ihre künftige Verarbeitung
						einzuschränken.
					</li>
					<li>
						<h3>Profiling</h3>
						ist jede Art der automatisierten Verarbeitung personenbezogener Daten, die darin besteht,
					...
					<li>
						...
						ist die Verarbeitung personenbezogener Daten in einer Weise, auf welche die personenbezogenen
					...
					<li>
						...
						ist eine natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle, die
					...
					<li>
						<h3>Dritter</h3>
						ist eine natürliche oder juristische Person, Behörde, Einrichtung oder andere Stelle außer
					...
					<li>
						<h3>Einwilligung</h3>
						ist jede von der betroffenen Person freiwillig für den bestimmten Fall in informierter Weise
			...
			<li>
				<h2>Cookies</h2>
				<p>
					Die Internetseiten der Bude Finder App verwenden Cookies. Cookies sind Textdateien, welche
				...
				<div class="p-1"></div>
				<p>
					Durch den Einsatz von Cookies kann die Bude Finder App den Nutzern dieser Internetseite
			...
			<li>
				...
				<p>
					Die Internetseite der Bude Finder App erfasst mit jedem Aufruf der Internetseite durch
					...
					Servers gespeichert. Erfasst werden können die (1) verwendeten Browsertypen und Versionen,
					(2) das vom zugreifenden System verwendete Betriebssystem, (3) die Internetseite, von
					welcher ein zugreifendes System auf unsere Internetseite gelangt (sogenannte Referrer),
					(4) die Unterwebseiten, welche über ein zugreifendes System auf unserer Internetseite
					angesteuert werden, (5) das Datum und die Uhrzeit eines Zugriffs auf die Internetseite,
				...
				<p>
					Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die Bude Finder App keine
					...
					anonym erhobenen Daten und Informationen werden durch die Bude Finder App daher einerseits
					statistisch und ferner mit dem Ziel ausgewertet, den Datenschutz und die Datensicherheit
					in unserem Unternehmen zu erhöhen, um letztlich ein optimales Schutzniveau für die von uns
			...
			<li>
				...
				<p>
					...
					ausschließlich für die interne Verwendung bei dem für die Verarbeitung Verantwortlichen
					und für eigene Zwecke erhoben und gespeichert. Der für die Verarbeitung Verantwortliche
					kann die Weitergabe an einen oder mehrere Auftragsverarbeiter, beispielsweise einen
					Paketdienstleister, veranlassen, der die personenbezogenen Daten ebenfalls ausschließlich
					für eine interne Verwendung, die dem für die Verarbeitung Verantwortlichen zuzurechnen
					ist, nutzt.
				</p>
				<p>
				...
				<p>
					...
					Registrierung angegebenen personenbezogenen Daten jederzeit abzuändern oder vollständig
					aus dem Datenbestand des für die Verarbeitung Verantwortlichen löschen zu lassen.
				</p>
				<p>
			...
			<li>
				...
				<p>
					Auf der Internetseite der Bude Finder App wird den Benutzern die Möglichkeit eingeräumt,
				...
				<p>
					Die Bude Finder App informiert ihre Kunden und Geschäftspartner in regelmäßigen Abständen
					im Wege eines Newsletters über Angebote des Unternehmens. Der Newsletter unseres
					Unternehmens kann von der betroffenen Person grundsätzlich nur dann empfangen werden, wenn
					(1) die betroffene Person über eine gültige E-Mail-Adresse verfügt und (2) die betroffene
					Person sich für den Newsletterversand registriert. An die von einer betroffenen Person
					erstmalig für den Newsletterversand eingetragene E-Mail-Adresse wird aus rechtlichen
			...
			<li>
				...
				<p>
					Die Newsletter der Bude Finder App enthalten sogenannte Zählpixel. Ein Zählpixel ist eine
					...
					die Bude Finder App erkennen, ob und wann eine E-Mail von einer betroffenen Person
				...
				<p>
					...
					den Interessen der betroffenen Person anzupassen. Diese personenbezogenen Daten werden
					nicht an Dritte weitergegeben. Betroffene Personen sind jederzeit berechtigt, die
					diesbezügliche gesonderte, über das Double-Opt-In-Verfahren abgegebene
					Einwilligungserklärung zu widerrufen. Nach einem Widerruf werden diese personenbezogenen
					Daten von dem für die Verarbeitung Verantwortlichen gelöscht. Eine Abmeldung vom Erhalt
				...
				<ul class="counter-alph">
					...
					<li>
						...
						<p>
							...
							Löschung von personenbezogenen Daten, die bei der Bude Finder gespeichert sind,
							veranlassen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
							Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Bude Finder App wird
							veranlassen, dass dem Löschverlangen unverzüglich nachgekommen wird.
						</p>
						<div class="p-1"></div>
						<p>
							Wurden die personenbezogenen Daten von der Bude Finder App öffentlich gemacht und ist
							unser Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
							personenbezogenen Daten verpflichtet, so trifft die Bude Finder App unter
							...
							der Bude Finder App wird im Einzelfall das Notwendige veranlassen.
						</p>
					</li>
					<li>
						...
						<p>
							...
							die Einschränkung von personenbezogenen Daten, die bei der Bude Finder App gespeichert
							sind, verlangen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für
							die Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der Bude Finder App wird die
					...
					<li>
						...
						<p>
							...
							jederzeit an einen Mitarbeiter der Bude Finder App wenden.
						</p>
					</li>
					<li>
						...
						<div class="p-1"></div>
						<p>
							Die Bude Finder App verarbeitet die personenbezogenen Daten im Falle des Widerspruchs
						...
						<div class="p-1"></div>
						<p>
							Verarbeitet die Bude Finder App personenbezogene Daten, um Direktwerbung zu betreiben,
							...
							Widerspricht die betroffene Person gegenüber der Bude Finder App der Verarbeitung für
							Zwecke der Direktwerbung, so wird die Bude Finder App die personenbezogenen Daten
						...
						<p>
							...
							bei der Bude Finder App zu wissenschaftlichen oder historischen Forschungszwecken oder
						...
						<p>
							...
							jeden Mitarbeiter der Bude Finder App oder einen anderen Mitarbeiter wenden. Der
					...
					<li>
						...
						<p>
							...
							ausdrücklicher Einwilligung der betroffenen Person, trifft die Bude Finder App
	...
	<div class="flex border-t border-white">
		<a class="p-4 flex-1" href="/info">Zurück</a>
	</div>
</div>
